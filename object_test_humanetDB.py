...
def launch_test(args):
    ...
    for filename in os.listdir(folder1):  # 5001 e 0 sono uguali quindi devi mettere da 5000
    ...
    try:
        ...
        with lock:
            with open('obj_test_humanet_prova.csv', 'a', newline='') as csvfile:
...
def main():
    ...
    PATH = "D:/Francesco Manigrasso/avatargenerator/object_humanet_28_11_23/objects"
    ...
    with open('obj_test_humanet_final_prova.csv', 'a', newline='') as csvfile:
        writer = csv.writer(csvfile, delimiter=';',
                            quotechar='|', quoting=csv.QUOTE_MINIMAL)
