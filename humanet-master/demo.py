...
ouput_path = "D:\\Francesco Manigrasso\\avatargenerator\\object_humanet"
...
def main():
    ...
    os.makedirs(join(ouput_path,"objects",args.gender),exist_ok=True)
    mesh.export(join(ouput_path,"objects",args.gender,args.mesh_name))
